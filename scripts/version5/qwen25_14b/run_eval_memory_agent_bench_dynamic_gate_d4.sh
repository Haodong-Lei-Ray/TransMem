...
#SBATCH -t 48:00:00
#SBATCH -o /mnt/petrelfs/leihaodong/Project4/logs/eval_memory_agent_bench/%j_q25_gate_d4.out
#SBATCH -e /mnt/petrelfs/leihaodong/Project4/logs/eval_memory_agent_bench/%j_q25_gate_d4.err

set -euo pipefail
PROJ=/mnt/petrelfs/leihaodong/Project4
export MODE=paired
export MODEL_NAME=Qwen/Qwen2.5-14B-Instruct
export S3_CKPT_REL=leihaodong/Project4/checkpoints/v5_gate_qwen25_14b_scratch_joint_d4/best.pt
